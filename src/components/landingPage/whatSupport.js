...
const WhatSupport = ({ blok }) => (
    ...
    <div className="container">
        <div className="w-8/12 mx-auto text-center mb-16">
            <h2 className="text-black font-bold text-3xl leading-none  mb-16 md:mb-24">What we support</h2>
        </div>
        <div className="grid sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-4 gap-x-10 gap-y-16 mb-10">
            ...
            <div className="text-center">
                ...
                <h3 className="text-xl font-bold">Hire to retire</h3>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
                ...
                <h3 className="text-xl font-bold">fly-in fly-out</h3>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
                <img className="w-24 mx-auto mb-4" src= {img7} alt=""/>
                <h3 className="text-xl font-bold">Workers compensation</h3>
            </div>
            <div className="text-center">
                <img className="w-24 mx-auto mb-4" src= {img8} alt=""/>
                <h3 className="text-xl font-bold">Illnesses</h3>
            </div>
        </div>
    </div>
</section>
