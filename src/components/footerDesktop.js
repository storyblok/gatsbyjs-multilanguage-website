    ...
    return (
        ...
        <Container className="flex-wrap justify-center items-center">
            ...
            <Nav className="justify-content-center">
                <a href="/why-triiyo" className="capitalize whitespace-nowrap font-karla font-medium text-gold_300 no-underline px-2 py-2">Contact</a>
                <a href="/resources" className="capitalize whitespace-nowrap font-karla font-medium text-gold_300 no-underline px-2 py-2">Support</a>
                <a href="/privacy" className="capitalize whitespace-nowrap font-karla font-medium text-gold_300 no-underline px-2 py-2">Privacy Policy</a>
                <a href="/terms-and-conditions" className="whitespace-nowrap font-karla font-medium text-gold_300 no-underline px-2 py-2">Terms of Service</a>
            ...
            <Nav>
                <Nav.Link href="https://www.facebook.com/hellotriiyo" className="whitespace-nowrap md:inline-flex text-center items-center justify-center px-2 py-2 text-base font-bold text-white hover:bg-navy_300">
                ...
                <Nav.Link href="https://www.instagram.com/hellotriiyo/?hl=en" className="whitespace-nowrap md:inline-flex text-center items-center justify-center px-2 py-2 text-base font-bold text-white hover:bg-navy_300">
                ...
                <Nav.Link href="https://www.linkedin.com/company/triiyo" className="whitespace-nowrap md:inline-flex text-center items-center justify-center px-2 py-2 text-base font-bold text-white hover:bg-navy_300">
                ...
                {/* <Nav.Link href="https://twitter.com/hellotriiyo" className="whitespace-nowrap md:inline-flex text-center items-center justify-center px-2 py-2 text-base font-bold text-white hover:bg-navy_300">
                ...
                <Nav.Link href="https://www.youtube.com/channel/UCh5aXITAPY_P_9PhKdb5FGQ" className="whitespace-nowrap md:inline-flex text-center items-center justify-center px-2 py-2 text-base font-bold text-white hover:bg-navy_300">
