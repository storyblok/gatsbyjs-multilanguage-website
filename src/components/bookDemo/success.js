    ...
    <section class="font-karla py-20 bg-white_100">
		<div class="container pt-20 pb-20">
			<div class="sm:w-8/12 mx-auto text-center mt-12 mb-8">
				...
				<h2 class="text-black leading-none mb-4">Thank you for your demo request</h2>
				<p class="font-normal textr-lg leading-snug text-black">
                    We will be in touch shortly to organise a time to show you everything about triiyo!
				</p>
			</div>
